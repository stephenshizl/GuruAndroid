...
public class AddPopWindow extends PopupWindow {
	...
	public AddPopWindow(final Activity context) {
        ...
        RelativeLayout   re_last =(RelativeLayout) conentView.findViewById(R.id.re_last);
        ...
        re_last.setOnClickListener(new OnClickListener(){

            @Override
            public void onClick(View v) {
                context.startActivity(new Intent(context,LasterLoginUserActivity.class));
                AddPopWindow.this.dismiss();
